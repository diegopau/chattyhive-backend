...
VALID_COUNTRIES = ('AD', 'AE', 'AF', 'AG', 'AI', 'AL', 'AM', 'AO', 'AQ', 'AR', 'AS', 'AT', 'AU', 'AW', 'AX', 'AZ', 'BA',
...
# Regions from all the listed countries (without cities)
...
cities_light.signals.country_items_pre_import.connect(filter_country_import)
