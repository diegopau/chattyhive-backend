...
urlpatterns = patterns('',
    ...
    url(r'^create_chat/(?P<hive_slug>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/(?P<public_name>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/',
        'test_ui.views.create_chat', name='create_chat'),
    url(r'^create_public_chat/(?P<hive_slug>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/',
    ...
    url(r'^join/(?P<hive_slug>[-a-zA-Z0-9ñÑáéíóú¿¡!?_ ]+)/', 'test_ui.views.join', name='join'),
    url(r'^leave/(?P<hive_slug>[-a-zA-Z0-9ñÑáéíóú¿¡!?_ ]+)/', 'test_ui.views.leave', name='leave'),
    url(r'^hive/(?P<hive_slug>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/', 'test_ui.views.hive', name='hive'),
    url(r'^hive_description/(?P<hive_slug>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/',
        'test_ui.views.hive_description', name='hive_description'),
    url(r'^hive_users/(?P<hive_slug>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/(?P<init>[0-9first]+)-(?P<interval>[0-9]+)/',
