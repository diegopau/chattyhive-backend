...
urlpatterns = patterns('',
    ...
    url(r'^join/(?P<hive_url>[-a-zA-Z0-9ñÑáéíóú¿¡!?_ ]+)/', 'test_ui.views.join', name='join'),
    url(r'^leave/(?P<hive_url>[-a-zA-Z0-9ñÑáéíóú¿¡!?_ ]+)/', 'test_ui.views.leave', name='leave'),
    url(r'^hive/(?P<hive_url>[-a-zA-ZñÑ0-9áéíóú¿¡!?_ ]+)/', 'test_ui.views.hive', name='hive'),
