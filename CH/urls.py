...
urlpatterns = patterns('',
    ...
    url(r'^change_password/', 'login.views.change_pass', name='change_password'),
    url(r'^change_pass/(\w+)/$', 'email_confirmation.views.change_password', name='change_password'),
    url(r'^pass_changed/$', 'email_confirmation.views.password_changed', name='password_changed'),
