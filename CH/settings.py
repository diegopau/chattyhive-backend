...
DATABASES = {
    'default': {
        ...
        'NAME': 'chattyolddb',  # Or path to database file if using sqlite3.
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://chattytestuser:chattytestpass@localhost/chattyolddb')}
